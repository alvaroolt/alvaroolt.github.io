...
if ($_SESSION["perfil"] == "invitado" || $_SESSION["perfil"] == "admin") {
    ...
    if ($_SESSION["estado"] == 0) {
        ...
        foreach ($listaObras as $value) {
            echo "<tr><td>" . $value["titulo"] . "</td><td>" . $value["descripcion"] . "</td><td><img src=\"./img/" . $value["portada"] . "\" alt=\"Imagen de la serie\" width=\"150\" height=\"150\"></img></td><td>" . $value["fecha_inicio"] . "</td><td>" . $value["fecha_final"] . "</td><td>" . $value["numero_valoraciones"] . "</td><td>" . $value["valoracion_media"] . "</td>";
            // echo "<td>Valorar</br>";
            // for ($i = 1; $i <= 5; $i++) {
